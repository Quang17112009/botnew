...
# ======================= HÀM XỬ LÝ DỰ ĐOÁN (Thuật toán mới của bạn) =======================
def du_doan_theo_xi_ngau(dice):
    ...
    for d in [d1, d2, d3]:
        tmp = d + total
        if tmp in [4, 5]: # Điều chỉnh theo logic mới của bạn
            tmp -= 4
        elif tmp >= 6: # Điều chỉnh theo logic mới của bạn
            tmp -= 6
